...
ggplot(sfo_crimedata_hourDF, aes(y=sfo_crimedata_hourDF$total, x= sfo_crimedata_hourDF$offensehour)) + geom_point(aes(color=offense)) + ggtitle("Hour vs Offense")  + xlab("Hour") +  ylab("Offense")
...
plot_ly(type="choropleth",locations=c('CA'),locationmode='USA-States',colorscale='Viridis',z=c(10,20,40)) %>% layout(geo=list(scope='usa')) 
