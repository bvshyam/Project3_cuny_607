...
if(isIdCurrent(conn))
{
     all_citycrimedata <-  dbGetQuery(conn,"select crimedata.citycode, offenseid, offense, offenselocaldate, offenselocaltime, dayofweek, offensehour, offensemonth, offensearea from crimedata, city where city.citycode = crimedata.citycode")
    
     
     data <- fetch(allcitycrimedata, n=10) 
