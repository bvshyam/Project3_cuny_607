...
Shyam, Mark did great work over finding interesting datasets and worked /analyzed on SFO , Chicago crime datasets. Kumudini contributed to working and analyzing on NYC crime data. Upal was very instrumental in setting the much required database on cloud and helping us be all in sync.
...
Upal also did some interesting mappings of the three cities SFO, NYC and Chicago crime datasets.
